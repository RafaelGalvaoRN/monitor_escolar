// estatisticas-eixos.js - Gerenciador de Estatísticas por Eixo
...
const GerenciadorEixos = {
    ...
    async gerarGraficosEixo(eixoKey) {
        ...
        console.log('Colunas:', colunasEixo);
    ...
    criarGraficoParaColuna(coluna, index, container) {
        try {
            ...
            setTimeout(() => {
                // Usa o módulo Estatisticas para plotar
                Estatisticas.plotColumn({
                    column: coluna,
                    pieCanvasId: idPizza,
                    barCanvasId: idBarra,
                    titleElIds: {} // Não precisamos atualizar títulos externos
                });
            }, 50);
